      ...
      {user && user.plan === "free" && (
        <div className="bg-blue-50 border-b border-blue-100 px-4 py-2">
          <div className="max-w-5xl mx-auto flex items-center justify-between text-sm">
            ...
            {analysisCount >= 3 && (
              <a href="/pricing" className="text-blue-600 font-medium hover:text-blue-500">
                Upgrade a Premium →
              </a>
            )}
          </div>
      ...
      {!analysisStarted ? (
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          <h1 className="text-4xl font-black text-slate-800 mb-4">
            ...
            <span className="text-blue-600">en minutos, no en días</span>
          </h1>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold text-lg px-8 py-4 rounded-2xl shadow-lg shadow-blue-200 transition transform hover:scale-105"
          >
